...
public class InteractorsModule {
  ...
  @Provides @Singleton GetContactsInteractor provideGetContactsInteractor(ContactsRepository repository) {
    return new GetContactsInteractor(repository);
  }

  @Provides @Singleton GetContactInteractor provideGetContactInteractor(ContactsRepository repository) {
